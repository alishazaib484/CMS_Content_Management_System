...
@Injectable()
export class CustomPageServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    getAll(): Observable<ListResultDtoOfGetAllPagesOutputDto> {
        let url_ = this.baseUrl + "/api/services/app/CustomPage/GetAll";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ListResultDtoOfGetAllPagesOutputDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<ListResultDtoOfGetAllPagesOutputDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<ListResultDtoOfGetAllPagesOutputDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ListResultDtoOfGetAllPagesOutputDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ListResultDtoOfGetAllPagesOutputDto>(<any>null);
    }
     ...
     * @return Success
     */
    getCMSContent(pageId: number | null | undefined): Observable<CustomPageDto> {
        let url_ = this.baseUrl + "/api/services/app/CustomPage/GetCMSContent?";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<CustomPageDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<CustomPageDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetCMSContent(response: HttpResponseBase): Observable<CustomPageDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return _observableOf<CustomPageDto>(<any>null);
    }
     ...
     * @return Success
     */
    insertOrUpdateCMSContent(input: CustomPageDto | null | undefined): Observable<string> {
        let url_ = this.baseUrl + "/api/services/app/CustomPage/InsertOrUpdateCMSContent";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processInsertOrUpdateCMSContent(response: HttpResponseBase): Observable<string> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    deleteCMSContent(pageId: number | null | undefined): Observable<string> {
        let url_ = this.baseUrl + "/api/services/app/CustomPage/DeleteCMSContent?";
        if (pageId !== undefined && pageId !== null)
            url_ += "pageId=" + encodeURIComponent("" + pageId) + "&";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processDeleteCMSContent(response: HttpResponseBase): Observable<string> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class ListResultDtoOfGetAllPagesOutputDto implements IListResultDtoOfGetAllPagesOutputDto {
    items: GetAllPagesOutputDto[] | undefined;

    constructor(data?: IListResultDtoOfGetAllPagesOutputDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            if (Array.isArray(_data["items"])) {
                ...
                for (let item of _data["items"])
                    this.items.push(GetAllPagesOutputDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): ListResultDtoOfGetAllPagesOutputDto {
        data = typeof data === 'object' ? data : {};
        let result = new ListResultDtoOfGetAllPagesOutputDto();
        result.init(data);
        return result;
    }
    ...
    clone(): ListResultDtoOfGetAllPagesOutputDto {
        const json = this.toJSON();
        let result = new ListResultDtoOfGetAllPagesOutputDto();
        result.init(json);
        return result;
...
export interface IListResultDtoOfGetAllPagesOutputDto {
    items: GetAllPagesOutputDto[] | undefined;
}

export class GetAllPagesOutputDto implements IGetAllPagesOutputDto {
    id: number | undefined;
    title: string | undefined;

    constructor(data?: IGetAllPagesOutputDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): GetAllPagesOutputDto {
        data = typeof data === 'object' ? data : {};
        let result = new GetAllPagesOutputDto();
        result.init(data);
        return result;
    }
...
export interface IGetAllPagesOutputDto {
    id: number | undefined;
    title: string | undefined;
}
