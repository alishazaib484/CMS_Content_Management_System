...
namespace CMS_Boilerplate.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = CMS_BoilerplateConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(CMS_BoilerplateDbContext context)
        {
            _context = context;
        }
